...
{
    public static readonly Role Demon = new()
    {
        Name = "Cute Demon", 
        Color = DiscordColor.Black, 
        Reason = "Autogenerated for cult bot."
    };
    public static readonly Role Cultist = new()
    {
        Name = "Cultist", 
        Color = DiscordColor.DarkRed, 
        Reason = "Autogenerated for cult bot."
    };
    public static readonly Role Sacrificed = new()
    {
        Name = "Sacrificed", 
